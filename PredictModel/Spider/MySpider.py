...
class Crawler(threading.Thread,):
    ...
    def saveTocsv(self, data, city):
        global abs_path
        fileName = abs_path + '/weather_data/' + 'weather.csv'
        result_weather = pd.DataFrame(data, columns=['date', 'weather', 'temp', 'wind'])
        # print(result_weather)
        result_weather.to_csv(fileName, index=0, encoding= "gb18030")
...
file_path = abs_path + "/city_pinyin_test.txt"
