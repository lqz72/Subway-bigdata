(function($) {
    ...
    var aa = header[0].firstElementChild.firstElementChild.firstElementChild.firstElementChild.firstElementChild;
    console.log(aa);
    var win = $(window);
    ...
    win.on('scroll', function() {
        ...
        if (scroll < 54) {
            ...
            aa.innerHTML = '<a href="index.html"><img src="../static/new/assets/img/logo/4.png" alt="" /></a>';
        } else {
            header.addClass('stick');
            aa.innerHTML = '<a href="index.html"><img src="../static/new/assets/img/logo/2.png" alt="" /></a>';
        }
    });
